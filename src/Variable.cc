...
/**
 * \file Variable.cc
 * @brief Implementation of Variable::methods which are not in the Variable.h (EMPTY)
 *
 * @note This file is empty for now (except the static declaration of nbVar)
 *
